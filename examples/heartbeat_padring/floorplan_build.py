...
def build_top():
    ...
    # Configure a minimal flow to stack the core and padring macros; no synthesis/APR/etc.
    # TODO: Use 'asictopflow' as part of a two-part flow once flow composability is done in sc.
    #flow = 'physflow'
