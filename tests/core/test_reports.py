...
def test_get_metrics_source():
    ...
    chip.set('tool', 'openroad', 'task', 'io_pin_placement', 'report',
             'metric', 'this file', step='floorplan.io_pin_placement', index='0')

    test = report.get_metrics_source(chip, 'floorplan.io_pin_placement', '0')
