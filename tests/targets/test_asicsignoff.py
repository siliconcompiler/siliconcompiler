...
_SIGNOFF = {
    ...
    # gcd on gf180 currently has 3 known CO.6a violations (Metal1 end-of-line
    # overlap of contact). Pin the count so the test still exercises DRC and
    # flags any change; drop to 0 once the layout is cleaned up.
