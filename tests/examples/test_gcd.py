...
def test_py_gcd_skywater():
    ...
    # 1x [RSZ-0066] Unable to repair all hold violations: RSZ-0046 finds 20
    #    endpoints with hold violations and the 4 buffers RSZ-0032 inserts
    #    leave -0.10 worst slack behind (hold TNS -1.11). Post-route timing
    #    repair is off in this flow, so nothing repairs them later.
