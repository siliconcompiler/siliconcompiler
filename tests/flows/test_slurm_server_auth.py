...
@pytest.mark.eda
def test_gcd_server_slurm_authenticated(gcd_chip, datadir):
    ...
    gcd_chip.set('remote', 'key', os.path.join(datadir, 'insecure_ci_keypair'))
    gcd_chip.run()
...
@pytest.mark.eda
def test_gcd_server_slurm_not_authenticated(gcd_chip, datadir):
