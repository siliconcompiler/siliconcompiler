...
@pytest.mark.eda
@pytest.mark.quick
def test_fpga_json_constraints(scroot,
    ...
    json_constraints = os.path.join(flow_root,
                                    ...
                                    benchmark_name,
                                    'constraints',
                                    f'pin_constraints_{arch_name}.json')

    chip.add('input', 'constraint', 'pinmap', json_constraints)
...
if __name__ == "__main__":
    ...
    test_fpga_json_constraints(scroot())
