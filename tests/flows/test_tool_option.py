...
def test_tool_option(scroot):
    ...
    assert chip.find_result('pkg.json', step='place.global_placement', index='0') is not None
    assert chip.find_result('pkg.json', step='place.global_placement', index='1') is not None
