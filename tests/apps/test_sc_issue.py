...
@pytest.mark.parametrize('flags,outputfileglob', [
    ...
    (['-cfg', 'build/heartbeat/job0/place.global_placement/0/outputs/heartbeat.pkg.json',
      '-arg_step', 'syn', '-arg_index', '0'],
     'sc_issue_heartbeat_job0_syn0_*.tar.gz'),
    (['-cfg', 'build/heartbeat/job0/place.global_placement/0/outputs/heartbeat.pkg.json',
      '-arg_step', 'place.global_placement', '-arg_index', '0'],
     'sc_issue_heartbeat_job0_place.global_placement0_*.tar.gz'),
