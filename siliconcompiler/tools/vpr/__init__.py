...
class VPRTask(Task):
    ...
    def setup(self):
        ...
        # NOTE: enable_images is required by the PlaceTask/RouteTask setups
        # (the only tasks that read it); it is not required here in the shared base,
        # where show/screenshot/genfasm never read it.
