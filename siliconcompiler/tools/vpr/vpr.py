...
class VPRTask(TaskSchema):
    ...
    def __init__(self, name: str = None):
        ...
        self.add_parameter("enable_images", "bool", "true/false generate images of the design at the end of the task", defvalue=True)
        self.add_parameter("timing_paths", "int", "balh", defvalue=20)
        self.add_parameter("timing_report_type", "<netlist,aggregated,detailed,debug>", "blah: vpr --timing_report_detail", defvalue="aggregated")
    ...
    def runtime_options(self):
        ...
        if False:  # use_timing_analysis(chip):
