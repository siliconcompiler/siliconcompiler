...
class RouteTask(VPRTask):
    def __init__(self):
        ...
        self.add_parameter("max_router_iterations", "int", "set maximum number of routing iterations", defvalue=50)
        self.add_parameter("gen_post_implementation_netlist", "bool", "set to true to have VPR generate a post-implementation netlist", defvalue=False)
        self.add_parameter("timing_corner", "str", "set the timing corner for files generated by the post-implementation netlist", defvalue="typical")
