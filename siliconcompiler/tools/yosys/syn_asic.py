...
class YosysStdCellLibrarySchema(StdCellLibrarySchema):
    def __init__(self):
        ...
        self.define_tool_parameter("yosys", "dff_fileset", "[str]", "long-blah")
...
class ASICSynthesis(YosysTask):
    ...
    def __init_techmapping_parameter(self):
        ...
        self.add_parameter(
            ...
            "tools/yosys/techmaps/lcu_kogge_stone.v",
    ...
    def setup(self):
        ...
        if self.get('var', 'abc_constraint_driver') is not None:
            ...
            if lib_driver:
                self.add_required_key(*mainlib._keypath, "tool", "yosys", "driver_cell")
                self.add_required_key(*self._keypath, "var", "abc_constraint_driver")
    ...
    def _prepare_synthesis_libraries(self):
        ...
        # corners = self.get("var", "synthesis_corner")
        # logger = self.logger()
