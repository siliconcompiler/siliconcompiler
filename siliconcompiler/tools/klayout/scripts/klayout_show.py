...
def main():
    ...
    if sc_fileext in ('lyrdb', 'ascii'):
        sc_report = schema.get('tool', 'klayout', 'task', task, 'var', 'showfilepath',
                               step=step, index=index)
        ...
        if 'showfilepath' in schema.getkeys('tool', 'klayout', 'task', task, 'var') and \
           schema.get('tool', 'klayout', 'task', task, 'var', 'showfilepath',
                      step=step, index=index):
    ...
    sc_exit = schema.get('tool', 'klayout', 'task', task, 'var', 'showexit', step=step, index=index)
