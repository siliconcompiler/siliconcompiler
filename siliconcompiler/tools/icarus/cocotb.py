...
class CocotbTask(Task):
    ...
    def _get_cocotb_config(self):
        ...
        Returns:
            tuple: (libs_dir, lib_name, libpython_path)
        ...
        try:
            ...
            lib_name = cocotb_tools.config.lib_name("vpi", "icarus")
            ...
            return libs_dir, lib_name, libpython_path
    ...
    def _setup_cocotb_environment(self):
        ...
        """
        libs_dir, _, libpython_path = self._get_cocotb_config()
    ...
    def runtime_options(self):
        ...
        libs_dir, lib_name, _ = self._get_cocotb_config()
