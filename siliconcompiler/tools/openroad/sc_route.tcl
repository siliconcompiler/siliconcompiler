...
if {[dict exists $sc_cfg eda $sc_tool $sc_step $sc_index variable grt_allow_congestion] &&
    [dict get $sc_cfg eda $sc_tool $sc_step $sc_index variable grt_allow_congestion] == "true"} {
