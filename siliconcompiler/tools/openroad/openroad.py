...
def setup(chip, mode='batch'):
    ...
    for task in tasks:
        ...
        for variable, value in [('ifp_tie_separation', '0'),
                                ...
                                ('grt_signal_min_layer', chip.get('constraint', 'net', '*', 'minlayer')),
                                ('grt_signal_max_layer', chip.get('constraint', 'net', '*', 'maxlayer')),
                                ('grt_clock_min_layer', chip.get('constraint', 'net', '*', 'minlayer')),
                                ('grt_clock_max_layer', chip.get('constraint', 'net', '*', 'maxlayer')),
