...
def schema_options(cfg):
    ...
    cfg['sv'] = {
        ...
        'requirement' : 'optional',
        'defvalue' : ['false'],
        'short_help' : 'SystemVerilog',
        'param_help' : 'sv <bool>',
        'example' : ['cli: -sv',
                     "api: chip.set('ir', 'true')"],
        'help': """
        Enables SystemVerilog support.
        """
    }
    ...
    cfg['ir'] = {
        ...
        'requirement' : 'optional',
        'defvalue' : ['verilog'],
        'short_help' : 'Compilation intermediate representation',
        'param_help' : 'ir <str>',
        'example' : ['cli: -ir uhdm',
                     "api: chip.set('ir', 'uhdm')"],
        'help': """
        Provides a string name for choosing the intermediate representation used
        as input for synthesis. Supported IRs are currently:

        1.) 'verilog': generated by sv2v.
        2.) 'uhdm': generated by the SureLog parser/compiler.
        """
    }
