...
from lambdapdk.icsprout55.libs.ics55_stdcell import ics55_LLSC_H7CR, ics55_LLSC_H7CL, ics55_LLSC_H7CH
...
def ics55_demo(
    ...
    project.set_mainlib(ics55_LLSC_H7CH())
    ...
    project.option.add_to("write.views")
