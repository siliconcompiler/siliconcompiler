...
from siliconcompiler.project import ASICProject
...
from siliconcompiler.tools.vpr import VPRLibrary
    ...
    def __init__(self):
        ...
        with self.active_dataroot("lambdapdk"):
            ...
            for layer, detate in [
                    ...
                    ('metal9', 0.25),
                    ('metal10', 0.25)]:
                self.set_openroad_globalroutingderating(layer, detate)
...
class K4_N8_6x6FPGA(YosysFPGA, VPRLibrary, FPGASchema):
    def __init__(self):
        super().__init__()
        self.set_name("K4_N8")
...
class K6_N8_28x28_BDFPGA(YosysFPGA, VPRLibrary, FPGASchema):
    def __init__(self):
        super().__init__()
        self.set_name("K6_N8")
...
def target_nangate45(project: ASICProject):
