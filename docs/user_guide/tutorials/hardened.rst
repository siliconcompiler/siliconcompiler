...
All these steps are contained in the `python script <https://github.com/siliconcompiler/siliconcompiler/blob/main/examples/mod_A_in_mod_B/silicon_compiler_mod_A_in_mod_B.py>`_.
...
.. literalinclude:: examples/mod_A_in_mod_B/silicon_compiler_mod_A_in_mod_B.py
    :language: python
    :lines: 39-45
...
.. literalinclude:: examples/mod_A_in_mod_B/and.v
    :caption: mod_and
    :language: verilog

.. literalinclude:: examples/mod_A_in_mod_B/top.v
    :caption: top
    :language: verilog
