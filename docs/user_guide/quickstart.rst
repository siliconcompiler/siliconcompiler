...
.. include:: quickstart/quickstart_banner.inc
...
See :ref:`remote processing <remote_processing>` to see details on how to run on a private server, and see :ref:`external tools` to see the additional tool installation requirements for running on your machine locally.
