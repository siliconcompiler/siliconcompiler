 ...
 | 'provenance' step 'author' <str>                     | Step Author                    | str             | optional   |           |
 | 'provenance' step 'userid' <str>                     | Step User ID                   | str             | optional   |           |
 | 'provenance' step 'signature' <str>                  | Step Signature                 | str             | optional   |           |
 | 'provenance' step 'org' <str>                        | Step Organization              | str             | optional   |           |
 | 'provenance' step 'location' <str>                   | Step Location                  | str             | optional   |           |
 | 'provenance' step 'date' <str>                       | Step Date Stamp                | str             | optional   |           |
 | 'provenance' step 'time' <str>                       | Step Time Stamp                | str             | optional   |           |
 ...
 | 'pdk' 'aprlayer' stackup metal 'name' <str>          | APR Layer Name Map             | str             | optional   |           |
 | 'pdk' 'aprlayer' stackup metal 'hgrid'               | APR Layer Horizontal Grid      | num             | optional   |           |
 | 'pdk' 'aprlayer' stackup metal 'vgrid'               | APR Layer Vertical Grid        | str             | optional   |           |
 | 'pdk' 'aprlayer' stackup metal 'hoffset'             | APR Layer Preferred Direction  | num             | optional   |           |
 | 'pdk' 'aprlayer' stackup metal 'voffset'             | APR Layer Preferred Direction  | str             | optional   |           |
 ...
 | 'asic' 'ndr' <str>                                   | Design Non-default Rules       | file            |            |           |
 | 'asic' 'minlayer' <str>                              | Design Minimum Routing Layer   | str             | asic       |           |
 | 'asic' 'maxlayer' <str>                              | Design Maximum Routing Layer   | str             | asic       |           |
 | 'asic' 'stackup' <str>                               | Design Metal Stackup           | str             | asic       |           |
 | 'asic' 'density' <num>                               | APR Target Core Density        | num             | !diesize   |           |
 | 'asic' 'coremargin' <num>                            | APR Block Core Margin          | num             | density    |           |
 ...
 | 'stdcell' libname 'spice' 'format' <file>            | Stdcell Spice Netlist          | file            | optional   |           |
 | 'stdcell' libname 'hdl' 'format' <file>              | Stdcell HDL Model              | file            | asic       |           |
 ...
 | 'stdcell' libname 'layoutdb' stackup format <file>   | Stdcell Layout Database        | file            | optional   |           |
 ...
 | 'macro' libname 'spice' 'format' <file>              | Macro Spice Netlist            | file            | optional   |           |
 | 'macro' libname 'hdl' 'format' <file>                | Macro HDL Model                | file            | asic       |           |
 ...
 | 'macro' libname 'layoutdb' stackup format <file>     | Macro Layout Database          | file            | optional   |           |
 ...
 | 'clock' clkname 'period' <num>                       | Design Clock Period            | num             | optional   |           |
 | 'clock' clkname 'jitter' <num>                       | Design Clock Jitter            | num             | optional   |           |
 | 'supply' supplname 'pin' <str>                       | Design Power Supply Name       | str             | optional   |           |
 | 'supply' supplyname 'level' <num>                    | Design Power Supply Level      | num             | optional   |           |
 | 'supply' supplyname 'noise' <num>                    | Design Power Supply Noise      | num             | optional   |           |
 | 'define' <str>                                       | Design Preprocessor Symbols    | str             | optional   |           |
 | 'ydir' \<dir\>                                       | Design Module Search Paths     | dir             | optional   |           |
 | 'idir' \<dir\>                                       | Design Include Search Paths    | dir             | optional   |           |
 ...
 | 'hashmode' <str>                                     | File Hash Mode                 | str             | optional   | NONE      |
 ...
 | 'bkpt' <str>                                         | A list of flow breakpoints     | str             | optional   | false     |
 | 'remote' <str>                                       | Remote Server Address          | str             | optional   |           |
 | 'remoteport' <str>                                   | Remove Server Port             | num             | remote     | 8080      |
 | 'permutations' <file>                                | Run Permutations File          | file            | optional   |           |
 | 'status' 'step' <str>                                | Current Compilation Step       | str             | optional   |           |
