...
The following are examples of pre-built :ref:`flows <dev_flows>` that come with SiliconCompiler which you can use for your own builds.
...
.. schema::
  :root: siliconcompiler.flows.asicflow/PNRFlow
