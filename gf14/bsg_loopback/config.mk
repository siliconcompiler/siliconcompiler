...
export VERILOG_FILES = $(PLATFORM_DIR)/bp/bsg_ac_io_complex_loopback/bsg_chip.sv2v.v \
                       $(PLATFORM_DIR)/bp/IN12LP_GPIO18_13M9S30P.blackbox.v

# export CACHED_NETLIST    = $(PLATFORM_DIR)/bp/bsg_ac_io_complex_loopback/dc/results/bsg_chip.mapped.flat.v
export CACHED_NETLIST    = $(PLATFORM_DIR)/bp/bsg_ac_io_complex_loopback/yosys/synth.v

export SDC_FILE      = $(PLATFORM_DIR)/bp/bsg_ac_io_complex_loopback/bsg_chip.elab.v.sdc
