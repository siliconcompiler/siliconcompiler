...
def setup_platform(chip):
    ...
    chip.set('pdk','aprlayer', stackup, 'm6', 'name', 'li1')
    chip.set('pdk','aprlayer', stackup, 'm6', 'xoffset', '0.23')
    chip.set('pdk','aprlayer', stackup, 'm6', 'xpitch',  '0.46')
    chip.set('pdk','aprlayer', stackup, 'm6', 'yoffset', '0.17')
    chip.set('pdk','aprlayer', stackup, 'm6', 'ypitch',  '0.34')
    chip.set('pdk','aprlayer', stackup, 'm6', 'adjustment', '1.0')

    chip.set('pdk','aprlayer', stackup, 'm1', 'name', 'met1')
    chip.set('pdk','aprlayer', stackup, 'm1', 'xoffset', '0.17')
    chip.set('pdk','aprlayer', stackup, 'm1', 'xpitch',  '0.34')
    chip.set('pdk','aprlayer', stackup, 'm1', 'yoffset', '0.17')
    chip.set('pdk','aprlayer', stackup, 'm1', 'ypitch',  '0.34')
    chip.set('pdk','aprlayer', stackup, 'm1', 'adjustment', '0.5')

    chip.set('pdk','aprlayer', stackup, 'm2', 'name', 'met2')
    chip.set('pdk','aprlayer', stackup, 'm2', 'xoffset', '0.23')
    chip.set('pdk','aprlayer', stackup, 'm2', 'xpitch',  '0.46')
    chip.set('pdk','aprlayer', stackup, 'm2', 'yoffset', '0.23')
    chip.set('pdk','aprlayer', stackup, 'm2', 'ypitch',  '0.46')
    chip.set('pdk','aprlayer', stackup, 'm2', 'adjustment', '0.5')

    chip.set('pdk','aprlayer', stackup, 'm3', 'name', 'met3')
    chip.set('pdk','aprlayer', stackup, 'm3', 'xoffset', '0.34')
    chip.set('pdk','aprlayer', stackup, 'm3', 'xpitch',  '0.68')
    chip.set('pdk','aprlayer', stackup, 'm3', 'yoffset', '0.34')
    chip.set('pdk','aprlayer', stackup, 'm3', 'ypitch',  '0.68')
    chip.set('pdk','aprlayer', stackup, 'm3', 'adjustment', '0.5')

    chip.set('pdk','aprlayer', stackup, 'm4', 'name', 'met4')
    chip.set('pdk','aprlayer', stackup, 'm4', 'xoffset', '0.46')
    chip.set('pdk','aprlayer', stackup, 'm4', 'xpitch',  '0.92')
    chip.set('pdk','aprlayer', stackup, 'm4', 'yoffset', '0.46')
    chip.set('pdk','aprlayer', stackup, 'm4', 'ypitch',  '0.92')
    chip.set('pdk','aprlayer', stackup, 'm4', 'adjustment', '0.5')

    chip.set('pdk','aprlayer', stackup, 'm5', 'name', 'met5')
    chip.set('pdk','aprlayer', stackup, 'm5', 'xoffset', '1.7')
    chip.set('pdk','aprlayer', stackup, 'm5', 'xpitch',  '3.4')
    chip.set('pdk','aprlayer', stackup, 'm5', 'yoffset', '1.7')
    chip.set('pdk','aprlayer', stackup, 'm5', 'ypitch',  '3.4')
    chip.set('pdk','aprlayer', stackup, 'm5', 'adjustment', '0.5')
